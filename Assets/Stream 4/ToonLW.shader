...
Shader "Amplify Streams 4/Toon LW"
{
	Properties
	{
		...
		_SpecSize2("Spec Size", Range( 0 , 1)) = 0
		_RimFalloff("Rim Falloff", Vector) = (0,0,0,0)
		_SpecIntensity2("Spec Intensity", Range( 0 , 1)) = 0
		_RimShadow("Rim Shadow", Range( 0 , 1)) = 0
		_Min2("Min", Float) = 1.1
		_Max2("Max", Float) = 1.12
		_Color("Color", Color) = (0,0,0,0)
		[ASEEnd]_SpecMap2("Spec Map", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_58_0 = ( ( _Color * SampleGradient( gradient16, ( ( (dotResult2*0.5 + 0.5) * max( max( break147.x , break147.y ) , break147.z ) ) + max( max( break162.x , break162.y ) , break162.z ) ) ) ) + ( _Color * float4( bakedGI23 , 0.0 ) ) + ( float4( temp_output_160_0 , 0.0 ) * _Color ) );
				...
				float smoothstepResult193 = smoothstep( _Min2 , _Max2 , pow( dotResult203 , _SpecSize2 ));
				float2 uv_SpecMap2 = IN.ase_texcoord3.xy * _SpecMap2_ST.xy + _SpecMap2_ST.zw;
				float4 Specular197 = ( ( ( smoothstepResult193 * tex2D( _SpecMap2, uv_SpecMap2 ) ) * _SpecIntensity2 ) * ase_lightAtten );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( temp_output_58_0 + ( float4( lerpResult53 , 0.0 ) * smoothstepResult48 * _RimColor ) ) + Specular197 ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18900
262;73;1240;613;368.7615;317.3648;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;192;-2094.214,1958.454;Float;False;Property;_Max2;Max;13;0;Create;True;0;0;0;False;0;False;1.12;1.12;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;204;-2394.652,1895.913;Float;False;Property;_SpecSize2;Spec Size;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;201;-2099.084,1881.743;Float;False;Property;_Min2;Min;11;0;Create;True;0;0;0;False;0;False;1.1;1.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;195;-1309.268,1976.679;Inherit;False;Property;_SpecIntensity2;Spec Intensity;9;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;194;-1888.646,2033.287;Inherit;True;Property;_SpecMap2;Spec Map;15;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;186;519,-174;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;11;Amplify Streams 4/Toon LW;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;0;  Blend;0;Two Sided;1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;0;Built-in Fog;0;DOTS Instancing;0;Meta Pass;0;Extra Pre Pass;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;5;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=987778B53EEB2AC4AC811967D09A0D8EAFC1A388